...
public class CompanyBean {
    ...
    private List<CompanyResultBean> result;
    ...
    public List<CompanyResultBean> getResult() {
        return result;
    }

    public void setResult(List<CompanyResultBean> result) {
        this.result = result;
    }
